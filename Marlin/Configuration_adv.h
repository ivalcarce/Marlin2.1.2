 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN //ISIDRO
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define LONG_FILENAME_HOST_SUPPORT      // ISIDRO Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  ...
  #define AUTO_REPORT_SD_STATUS           // ISIDRO Auto-report media status with 'M27 S<seconds>'
   ...
   */
  #define SDCARD_CONNECTION ONBOARD //ISIDRO
...
#define SERIAL_FLOAT_PRECISION 4 //ISIDRO
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_12V        // ISIDRO All axes (override below)
